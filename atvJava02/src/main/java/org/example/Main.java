...
public class Main {
    public static void main(String[] args) {
     ...
     //Atividades – Funções Matemáticas em Java
        ...
        System.out.print("Resultado:"+raizResposta);
        ...
        System.out.print("Resultado:"+absResultado);
        ...
        double arredondamento = sc.nextInt();
